    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.startTimeUnixNano = longToNumber(reader.fixed64());
          continue;
        }
        case 8: {
          if (tag !== 65) {
          ...
          message.endTimeUnixNano = longToNumber(reader.fixed64());
          continue;
        }
        case 9: {
          if (tag !== 74) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.timeUnixNano = longToNumber(reader.fixed64());
          continue;
        }
        case 2: {
          if (tag !== 18) {
